		...
		<table class="commonTable" cellspacing="1">
	       <tr>
	        ...
	        <tr>
	            ...
	            <input type="radio" name="ctype" class="input"  value="货物" checked="checked">货物
	            <input type="radio" name="ctype" class="input" value="附件" >附件
	            </td>
	        </tr>
	         <tr>
	            <td class="columnTitle">说明</td>
	            <td class="tableContent"><textarea name="remark" rows="10" cols="150"></textarea>${remark }</td>
	        </tr>	
	         <tr>
	            <td class="columnTitle">地址</td>
	            <td class="tableContent"><textarea name="address" rows="10" cols="150"></textarea></td>
	        </tr>					
		</table>
	</div>
 </form>
