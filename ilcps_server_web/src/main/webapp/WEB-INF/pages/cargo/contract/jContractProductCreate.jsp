...
<li id="back"><a href="#" onclick="formSubmit('contractAction_list','_self');this.blur();">返回</a></li>
</ul>
  </div>
</div>
</div>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="file" name="image" /></td>
	        </tr>		
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="packingUnit" checked="checked" value="PCS" class="input">只
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td><img width="75" height="35" alt="暂无图片" src="${ctx}/ufiles/jquery/${o.productImage}"></td>
		<td>${o.factoryName}</td>
		<td>${o.productNo}</td>
		<td>${o.loadingRate}</td>
		<td>${o.boxNum}</td>
	...
	<tr height="40" class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td><img width="75" height="35" alt="暂无图片" src="${ctx}/ufiles/jquery/${ext.productImage}"></td>
