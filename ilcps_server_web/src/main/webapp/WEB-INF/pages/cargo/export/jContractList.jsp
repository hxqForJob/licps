...
<head>
	...
	//formSubmit('${ctx}/cargo/contractAction_print','_self');this.blur();
	//报运购销合同
...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="toView('contractAction_toview')">查看</a></li>
<li id="print"><a href="#" onclick="toUpdate('contractAction_print')">打印</a></li>
<li id="new"><a href="#" onclick="exportContract('exportAction_tocreate')">报运</a></li>
</ul>
  </div>
</div>
</div>
